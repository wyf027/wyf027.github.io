...
- Eligible projects: 13, including WYF Screenshot Studio.
- Excluded: `daodejing-atlas` because its 657 referenced images are absent from the repository.
...
- Rendered project cards: 13.
- Rendered preview links: 13.
- Rendered source links: 13.
